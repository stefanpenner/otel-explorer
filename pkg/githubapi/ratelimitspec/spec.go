...
// Regenerate: specgen -const MaxRem=2 -const MaxClock=3 -const Bug=FALSE -o pkg/githubapi/ratelimitspec -p ratelimitspec specs/rate-limit/decision/Decision.tla
//
